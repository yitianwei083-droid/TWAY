            ...
            ${mediaList.length > 0 ? html`
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(160px, 1fr)); gap: 12px; margin-bottom: 12px;">
                    ${mediaList.map(item => html`
                        <div key=${item.id} style="position: relative; border-radius: 6px; overflow: hidden; background: #ffffff; height: 120px; border: 1px solid rgba(0,0,0,0.08);">
                            ${item.isVideo 
...
function App() {
    ...
    return html`
        ...
        <div role="main" class="container ow-main">
                            ...
                            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 12px;">
                                <a href="#experience-education" class="terminal-btn" style="display: flex; align-items: center; justify-content: space-between; padding: 12px; text-align: left; text-decoration: none;">
                                    <div>
                                        ...
                                        <div style="font-size: 0.75rem; color: var(--text-secondary);">苏州大学硕士、网易/微盟/明基等名企实习</div>
                                    </div>
                    ...
                    <section id="experience-education" class="reveal" style="margin-bottom: 40px;">
                        ...
                        <div class="timeline">
                            <div class="timeline-item">
                                <div class="timeline-role">营销增长运营 / 品牌传播</div>
                                <div class="timeline-company">杭州网易智企科技有限公司</div>
                                <div class="timeline-date font-mono" style="color: var(--text-secondary); margin-bottom: 6px;">2026.08 - 至今</div>
                                <p>策划并搭建智企 GEO 知识库，覆盖 5 大业务线，负责帝王蟹 ClawHive 产品资料解析与知识库建设；参与 GEO 监测指标与行业场景问题设计，铺设 GEO 文章提升 AI 搜索曝光与触达。参与 ClawHive 教师节 B 端 Campaign 提案及「走进网易」品牌活动策划，负责产业家专访 PR 撰写，单篇最高 2.3 万阅读，累计覆盖 20+ 媒体渠道。参与 Palantir 招股书拆解，梳理 To B Agent 商业逻辑与竞争壁垒；利用 Workbuddy/Codex/ClawHive 等 Agent 搭建提效工具。</p>
                                <div class="timeline-tags" style="margin-top: 8px; display: flex; flex-wrap: wrap; gap: 6px;">
                                    <span class="tag">品牌传播</span>
                                    <span class="tag">整合营销</span>
                                    <span class="tag">Agent 产品推广</span>
                                    <span class="tag">AI 提效工具</span>
                                </div>
                            </div>
